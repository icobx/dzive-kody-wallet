...
import com.example.dzivekodywallet.database.*
...
class AppDatabaseTest {
    ...
    fun insertAndGetTransaction() {
        ...
        val firstTransaction = appDao.getTransaction(1)

        Log.d(transaction.transactionId.toString(), transaction.amount.toString())
