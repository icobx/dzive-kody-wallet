...
object Injection {
   fun provideWalletsViewModelFactory(context: Context): WalletsViewModelFactory {
       val walletRepository = WalletRepository.getInstance(
           ...
           AppDatabase.getInstance(context).operationDao,
           StellarService.getInstance())
    ...
    fun provideContactsViewModelFactory(context: Context): ContactsViewModelFactory {
        val contactRepository = ContactRepository.getInstance(
    ...
    fun provideSendReceiveViewModelFactory(context: Context): SendReceiveViewModelFactory {
        val sendReceiveRepository = ContactRepository.getInstance(
            AppDatabase.getInstance(context).contactDao)
